...
<div id="feedback">
    <div id="feedback-form" style='display:none;' class="col-xs-4 col-md-4 text-center thumbnail newthumbnail " style="padding:10px">
...
<div id="feed-cont">
        ...
        <input class="form-control nobr" id="feed_email" name="email" value="<?php  if($_SESSION['u_id']){ echo $rowu['emailid']; }?>" style="<?php  if($_SESSION['u_id']) {echo 'display:none;';} ?>" placeholder="E-mail" type="email" />
        </div>

        <select id="feed_option" class="form-control nobr">
       <option value="" style="display:none">Please select a category</option>
        ...
        <div class="form-group">
          <textarea class="form-control nobr" name="body" id="feed_exp" required placeholder="Please tell us, how we can improve..." rows="5"></textarea>
        </div>
        <button class="btn btn-new btn-block pull-left" id="feed_send">Send</button>
