...
$cfg['blowfish_secret'] = 'fuckoff'; /* YOU MUST FILL IN THIS FOR COOKIE AUTH! */
...
$i++;
$cfg['Servers'][$i]['host']          = '567d2ac789f5cfa4e30001cd-counselors.rhcloud.com:57421'; // MySQL hostname or IP address
...
$cfg['Servers'][$i]['controlpass']   = '';          // access to the "mysql/user"
                                                    // and "mysql/db" tables).
         $cfg['LoginCookieValidity'] = 36000000;                                           // The controluser is also
...
$cfg['Servers'][$i]['verbose_check'] = TRUE;        // set to FALSE if you know that your pma_* tables
            $cfg['ForceSSL'] = true;                                        // are up to date. This prevents compatibility
