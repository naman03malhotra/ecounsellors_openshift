...
$cur=end( explode( '/', $_SERVER['REQUEST_URI'] ) );
if($_GET['code'])
{
$code = $_GET['code'];
...
//if(isset($_POST['fblogin']))
					...
					$my_url = "https://ecounsellors.in/c/$cur";
					...
					else
					{
						...
						query("INSERT INTO u_users(emailid,name,status,u_id,url) values('$emailid','$username','f','$uid','$url')");
						query("INSERT INTO u_userdata(emailid,u_id,fbl) values('$emailid','$uid','$link')");
						$_SESSION['u_id']=$uid;
