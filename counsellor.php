...
;margin-bottom: 50px">
    <?php 
         ...
         echo '<button onclick="notify()" class="wow btn btn-lg btn-block btn-new btn-big-ye" data-toggle="modal" data-target=".xt" style="animation-duration: 2s;min-height: 42px;font-size: 18px;" >All Slots are booked(Notify Me!)</button><br>';
          ...
          {
             echo '<button class="wow btn btn-lg btn-block btn-new btn-big-re" data-toggle="modal" data-target=".xt" style="animation-duration: 2s;min-height: 42px;font-size: 18px;" >Talk To The Expert</button><br>';
     ...
     $_SESSION['cur']=$cur;
     if($no_slot_avail==0)
      echo '<a class="wow btn btn-block btn-big-re" onclick="logx(\'next\',\'book\')" style=" animation-duration: 2s;min-height: 42px;font-size: 18px;" >Talk To The Expert</a><br>';
    else
      echo '<a class="wow btn btn-block btn-big-re" onclick="logx(\'next\',\'notify\')" style=" animation-duration: 2s;min-height: 42px;font-size: 18px;" >Talk To The Expert</a><br>';
