...
<script type="text/javascript">
	...
	<?php  include('includes/header.php'); ?>
				...
				if($rowf['verifyf']=="3"&&!isset($_POST['ch'])&&!isset($_POST['change'])){
					...
					<div class="10u">
					<h2 class="bg-pers">Upload Profile Picture*</h2><h4 class="btn-black">Only JPEG/PNG/GIF files are accepted, Image size must be less than 1 MB</h4>';
					...
					{
						echo '<img class="img-rounded"style="height: 200px;width:200px;"src="'.$rowf['propic'].'"/>';
					}
					if(isset($_POST['up']))
					{
...

      {
			...
			/*	if($agent=="0"&&$rowf['verifyf']==""&&!isset($_POST['ch'])&&!isset($_POST['change'])){
							...
							if($rowf['verifyf']==""&&!isset($_POST['ch'])&&!isset($_POST['change'])&&isset($_SESSION['couns']))
							{
								...
								<div class="u"></div>
								<div class="10u">
								<input class="" id="phone" type="number"  name="phone"  required  maxlength="14" placeholder="Phone Number: You will be verified via call.">
								</div>
...
<tr><th>You Can Advice on:</th><td> <textarea class="" id="abt" type="text"  name="skills" value=""  placeholder="About You">'.$rowf['skills'].' </textarea> </td></tr>
...
filepicker.pick(
 {
    ...
    services: ['CONVERT','COMPUTER', 'FACEBOOK', 'CLOUDAPP','WEBCAM','GMAIL',['INSTAGRAM']]
  },
  function(Blob){
   var url= Blob.url;
