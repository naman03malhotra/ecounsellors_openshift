...
<head>
  ...
  <title>Ecounsellors - Privacy Policy</title>
...
<body>
  ...
  <div id="mainx">
    ...
    <section class="two">
                  ...
                  <div class="panel-heading" >
                    <h4 class="panel-title" >
                      <a data-toggle="collapse" data-parent="#accordionx" href="#collapseOnexyz">
                       <h1 style="text-align:center;color:#00bef2;">Privacy Policy<i class="indicator fa fa-angle-down  pull-right"></i></h1>
                     </a>
                   </h4>
                 </div>
        ...
        <?php
        if($agent==1)
          echo'<iframe src="https://docs.google.com/document/d/1jGqeaI98cBWfSn95XMFTmHQzASGYX2ztiHXcNY92GF0/pub?embedded=true" width="900" height="749" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>';
          else
          echo'<iframe src="https://docs.google.com/document/d/1jGqeaI98cBWfSn95XMFTmHQzASGYX2ztiHXcNY92GF0/pub?embedded=true" width="400" height="749" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>';
