     ...
     /* if (catName === undefined || /\s/.test(l.uuid)) {
      ...
      if(template.cats.indexOf(l.uuid) > -1) {
        l.status = 'online';
                  ...
                  {
                    if(usr_set=="y")
                       document.getElementById('m_status').innerHTML='<i>Mentor:</i><span class="online"></span>'
                     else
        ...
        l.status = 'offline';
             if(l.uuid!=uuid){
                  if(usr_set=="y")
                       document.getElementById('m_status').innerHTML='<i>Mentor:</i><span class="offline"></span>'
                     else
