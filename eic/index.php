<title>EIC Tracking panel - ecounsellors.in</title>
<?php
...
include('../includes/header.php');
	...
	/*	$q=query2("SELECT * from eic","mark");
		...
		while($q_qer=mysqli_fetch_array($q))
		{
					...
					$refx="https://ecounsellors.in/?lo&eic=".$ref;
					$img_url="https://ecounsellors.in/color-yourself/?eic=".$ref;
					query2("UPDATE eic set ref='$ref',ref_url='$refx',img_url='$img_url' where id='$id'","mark");
		}
		*/
...
if(isset($_POST['sub']))
{
	...
	$email=$_POST['email'];
		...
		$q=query2("SELECT * from eic where ref='$code' and email like '%$email%'","mark");
		$q_num=mysqli_num_rows($q);
		...
		if($q_num>0)
		{
			...
			{
				echo "<h3 class='text-center bg-primary'>THIS PORTAL WILL ONLY OPEN ONCE YOU SIGN UP YOURSELF OR ONE OF YOUR FRIENDS USING YOUR UNIQUE 'EIC' LINK GIVEN TO YOU. </h3>";
			}
...
<html>
<head>
	<title>EIC Tracking panel</title>
</head>
<body>
<div class="container">
    <div class="row">
