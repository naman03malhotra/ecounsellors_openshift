...
function stag_sanitize_font_choice( $value ) {
	if ( is_int( $value ) ) {
		...
		return '';
	} else if ( array_key_exists( $value, stag_all_font_choices() ) ) {
		return $value;
	} else {
		return '';
	}
...
function stag_get_all_fonts() {
	...
	$heading2       = array( 2 => array( 'label' => sprintf( '&mdash; %s &mdash;', __( 'Google Fonts', 'stag' ) ) ) );
	$google_fonts   = stag_get_google_fonts();
	return apply_filters( 'stag_all_fonts', array_merge( $heading1, $standard_fonts, $heading2, $google_fonts ) );
}
endif;
 ...
 *
 * 676 fonts, last updated - Oct 6, 2014.
 *
 * @since  1.0.0.
 *
...
function stag_get_google_fonts() {
	return apply_filters( 'stag_get_google_fonts', array(
		...
		'Arimo' => array(
			'label' => 'Arimo',
			'variants' => array( 'regular', 'italic', '700', '700italic' ),
			'subsets' => array( 'vietnamese', 'cyrillic-ext', 'greek', 'latin', 'latin-ext', 'greek-ext', 'cyrillic' )
		),
		'Arizonia' => array(
			'label' => 'Arizonia',
			'variants' => array( 'regular' ),
		...
		'Cardo' => array(
			'label' => 'Cardo',
			'variants' => array( 'regular', 'italic', '700' ),
			'subsets' => array( 'greek', 'latin', 'latin-ext', 'greek-ext' )
		),
		'Carme' => array(
			'label' => 'Carme',
			'variants' => array( 'regular' ),
		...
		'Comfortaa' => array(
			'label' => 'Comfortaa',
			'variants' => array( '300', 'regular', '700' ),
			'subsets' => array( 'cyrillic-ext', 'greek', 'latin', 'latin-ext', 'cyrillic' )
		),
		'Coming Soon' => array(
			'label' => 'Coming Soon',
			'variants' => array( 'regular' ),
		...
		'Didact Gothic' => array(
			'label' => 'Didact Gothic',
			'variants' => array( 'regular' ),
			'subsets' => array( 'cyrillic-ext', 'greek', 'latin', 'latin-ext', 'greek-ext', 'cyrillic' )
		),
		'Diplomata' => array(
			'label' => 'Diplomata',
			'variants' => array( 'regular' ),
		...
		'Noto Sans' => array(
			'label' => 'Noto Sans',
			'variants' => array( 'regular', 'italic', '700', '700italic' ),
			'subsets' => array( 'vietnamese', 'cyrillic-ext', 'greek', 'latin', 'devanagari', 'latin-ext', 'greek-ext', 'cyrillic' )
		),
		'Noto Serif' => array(
			'label' => 'Noto Serif',
			'variants' => array( 'regular', 'italic', '700', '700italic' ),
