		...
		$wp_customize->add_control(
			new Stag_Customize_Misc_Control(
				...
				array(
					'section'     => $section,
					'type'        => 'text',
					'description' => sprintf( __( 'For more information about Typekit integration, please see <a target="_blank" href="%1$s">%2$s\' documentation</a>.', 'stag' ), 'http://docs.codestag.com/article/144-typekit-integration', STAG_THEME_NAME ),
					'priority'    => 182,
				)
			)
		);
