...
<html>
<head>
<script src="//js.pusher.com/3.0.0/pusher.js"></script>
...
var pusher = new Pusher("c7b1065d29b9e84f34f4");
pusher.channel_auth_endpoint = "/pusher/pusher_auth.php";
var nettuts_channel = pusher.subscribe("presence-test_channelxuvi12389");
...
<body>
    <div id="chat_widget_container">
        <div id="chat_widget_login">
            ...
            <img src="https://nettuts.s3.amazonaws.com/1059_pusher/loading.gif" alt="Logging in..." id="chat_widget_login_loader" />
        </div>
        ...
        <div id="chat_widget_main_container">
            ...
            <div id="chat_widget_input_container">
                <form method="post" id="chat_widget_form">
                    ...
                    <img src="https://nettuts.s3.amazonaws.com/1059_pusher/loading.gif" alt="Sending..." id="chat_widget_loader" />
                </form>
            </div>
        </div>
    </div>
